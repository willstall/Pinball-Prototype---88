...
public class SpawnerInRadius: MonoBehaviour
{
	...
	*/
	...
	{
        Vector3 targetPosition = Random.insideUnitCircle * Random.Range(0, radius); 
		GameObject go = Instantiate(objectToInstantiate, targetPosition, Quaternion.identity) as GameObject;
